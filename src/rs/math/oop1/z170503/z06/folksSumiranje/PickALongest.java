package rs.math.oop1.z170503.z06.folksSumiranje;

import static rs.math.oop1.z170503.z06.folksSumiranje.Folks.friends;
  ...
  public static void main(final String[] args) {
    {
      ...
      System.out
          .println("Total number of characters in all names: " + friends.stream().mapToInt(ime -> ime.length()).sum());
    }
