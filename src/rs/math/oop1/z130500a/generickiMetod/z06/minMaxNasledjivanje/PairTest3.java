...
public class PairTest3 {
	public static void prikaziParDrugara(Pair<? extends Zaposleni> p) {
		Zaposleni first = p.getFirst();
		Zaposleni second = p.getSecond();
		System.out.println(first.getIme() + " i " + second.getIme() + " su drugari.");
	}
	...
	public static void main(String[] args) {
		...
		Manager vlasnikovSin = new Manager("Tatin sin", 800_000, 2012, 1, 12);
		Pair<Manager> buddies = new Pair<>(ceo, cfo);
		prikaziParDrugara(buddies);
		...
		System.out.println("first: " + result.getFirst().getIme() + ", second: " + result.getSecond().getIme());
