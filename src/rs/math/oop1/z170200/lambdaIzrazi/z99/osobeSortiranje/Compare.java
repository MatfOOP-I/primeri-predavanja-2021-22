package rs.math.oop1.z170200.lambdaIzrazi.z99.osobeSortiranje;
...
public class Compare {
        ...
        public static void main(String[] args) {
...

                {
                        ...
                        List<Person> ascendingAge = people.stream().sorted(Person::ageDifference).collect(toList());
...

                {
                        ...
                        printPeople("Sorted in ascending order by ime: ", people.stream()
                                        .sorted((person1, person2) -> person1.getIme().compareTo(person2.getIme()))
                                        .collect(toList()));
                ...
                {
                        people.stream().sorted((person1, person2) -> person1.getIme().compareTo(person2.getIme()));

                        printPeople("Sorted in ascending order by ime: ", people.stream()
                                        .sorted(comparing((Person person) -> person.getIme())).collect(toList()));
...

                {
                        ...
                        printPeople("Sorted in ascending order by age and ime: ", people.stream()
                                        .sorted(comparing(byAge).thenComparing(byTheirName)).collect(toList()));
